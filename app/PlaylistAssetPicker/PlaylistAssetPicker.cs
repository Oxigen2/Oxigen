...
namespace OxigenIIAdvertising.PlaylistLogic
{
    ...
    public class PlaylistAssetPicker
    {
        ...
        public ChannelAssetAssociation CreateNoAssetsChannelAssetAssociation()
        {
            return new ChannelAssetAssociation(0, new ContentPlaylistAsset(_displayMessageAssetDisplayLength, "There are currently no assets to display", "app://ContentExchanger"));
        }
    }
}

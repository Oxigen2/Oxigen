	...
	<p>
		...
		<ol>
			<li>
				...
				within Oxigen.Web/NHibernate.config</span>
			</li>
			<li>
				Optionally, modify the Fluent NHibernate preferences within Oxigen.Data.NHibernateMaps.GetConventions()
			...
			<li>
				Open Oxigen.Tests.dll via NUnit and make sure all the tests are turning green.
			</li>
			<li>
				...
				Oxigen.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
			</li>
		</ol>
	</p>
	<p>

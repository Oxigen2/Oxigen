<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="OxigenIIPresentation.Admin.ClientUsers.Edit" %>
...
<h1>Edit Client User</h1>
  ...
  <div class="AdminRight">
    ...
    <div class="FormBox">
      <div class="FormLabel"><asp:Label AssociatedControlID="txtPassword" runat="server">Site Password:&nbsp;<span class="Asterisk">*</span></asp:Label></div>
      <div class="FormField"><asp:textbox TabIndex="1" id="txtPassword" TextMode="Password" cssclass="EditBoxW1 WithFocusHighlight" maxlength="150" runat="server"/></div>

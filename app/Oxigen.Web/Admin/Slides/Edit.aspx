<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="OxigenIIPresentation.Admin.Slides.Edit" %>
...
<h1>Edit Slide</h1>
  ...
  <div class="AdminLeft">
    <div class="FormBox">
      <div class="FormLabel"><asp:Label AssociatedControlID="ddlType" runat="server">Slide Folder:&nbsp;<span class="Asterisk">*</span></asp:Label></div>
      <div class="FormField">
  ...
  <div class="AdminRight">
    <div class="FormBox">
      <div class="FormLabel"><asp:Label AssociatedControlID="txtUrl" runat="server">Download Slide:</asp:Label></div>
      <div class="FieldView"><asp:HyperLink runat="server">Click Here</asp:HyperLink></div>
    </div>
    <div class="FormBox">

...
{
  /// <summary>
  /// Provides methods to encrypt-decrypt arrays of bytes. Uses MemoryStreams and CryptoStreams, however
  /// CryptoStreams close and dispost their underlying MemoryStreams. For use with MemoryStreams, new MemoryStreams
  /// must be created.
  /// </summary>

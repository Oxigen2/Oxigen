...
namespace DirectoryEnumerator
{
  ...
  public static class FastDirectoryEnumerator
  {
    ...
    {
      return FastDirectoryEnumerator.EnumerateFiles(path, "*", 0);
    }

    public static IEnumerable<string> EnumerateFiles(string path, int limit)
    {
      return FastDirectoryEnumerator.EnumerateFiles(path, "*", limit);
    }
    ...
    {
      return FastDirectoryEnumerator.EnumerateFiles(path, searchPattern, SearchOption.TopDirectoryOnly, 0);
    }

    public static IEnumerable<string> EnumerateFiles(string path, string searchPattern, int limit)
    {
      return FastDirectoryEnumerator.EnumerateFiles(path, searchPattern, SearchOption.TopDirectoryOnly, limit);
    }

    public static IEnumerable<string> EnumerateFiles(string path, string searchPattern, SearchOption searchOption)
    {
      return EnumerateFiles(path, searchPattern, searchOption, 0);
    }
    ...
    /// </exception>
    public static IEnumerable<string> EnumerateFiles(string path, string searchPattern, SearchOption searchOption, int limit)
    {
      if (path == null)
      {
      ...
      return new FileEnumerable(fullPath, searchPattern, searchOption, limit);
    }
    ...
    /// <paramref name="filter"/> is a null reference (Nothing in VB)
    /// </exception>
    public static string[] GetFiles(string path, string searchPattern, SearchOption searchOption, int limit)
    {
      IEnumerable<string> e = FastDirectoryEnumerator.EnumerateFiles(path, searchPattern, searchOption, limit);
    ...
    private class FileEnumerable : IEnumerable<string>
    {
      ...
      /// operation should include all subdirectories or only the current directory.
      /// </param>
      public FileEnumerable(string path, string filter, SearchOption searchOption, int limit)
      {
        m_path = path;
        m_filter = filter;
      ...
      {
        return new FileEnumerator(m_path, m_filter, m_searchOption, m_limit);
      }
    ...
    private class FileEnumerator : IEnumerator<string>
    {
      ...
      /// operation should include all subdirectories or only the current directory.
      /// </param>
      public FileEnumerator(string path, string filter, SearchOption searchOption, int limit)
      {
        m_path = path;
        m_filter = filter;
        m_searchOption = searchOption;

USE [master]
GO
/****** Object:  Database [oxigen_live]    Script Date: 04/04/2011 13:38:31 ******/
CREATE DATABASE [oxigen_live] ON  PRIMARY 
( NAME = N'OxigenIIChannels', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\oxigen_live.mdf' , SIZE = 84096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'OxigenIIChannels_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\oxigen_live.ldf' , SIZE = 92864KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [oxigen_live] SET COMPATIBILITY_LEVEL = 100
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [oxigen_live].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [oxigen_live] SET ANSI_NULL_DEFAULT OFF
GO
ALTER DATABASE [oxigen_live] SET ANSI_NULLS OFF
GO
ALTER DATABASE [oxigen_live] SET ANSI_PADDING OFF
GO
ALTER DATABASE [oxigen_live] SET ANSI_WARNINGS OFF
GO
ALTER DATABASE [oxigen_live] SET ARITHABORT OFF
GO
ALTER DATABASE [oxigen_live] SET AUTO_CLOSE OFF
GO
ALTER DATABASE [oxigen_live] SET AUTO_CREATE_STATISTICS ON
GO
ALTER DATABASE [oxigen_live] SET AUTO_SHRINK OFF
GO
ALTER DATABASE [oxigen_live] SET AUTO_UPDATE_STATISTICS ON
GO
ALTER DATABASE [oxigen_live] SET CURSOR_CLOSE_ON_COMMIT OFF
GO
ALTER DATABASE [oxigen_live] SET CURSOR_DEFAULT  GLOBAL
GO
ALTER DATABASE [oxigen_live] SET CONCAT_NULL_YIELDS_NULL OFF
GO
ALTER DATABASE [oxigen_live] SET NUMERIC_ROUNDABORT OFF
GO
ALTER DATABASE [oxigen_live] SET QUOTED_IDENTIFIER OFF
GO
ALTER DATABASE [oxigen_live] SET RECURSIVE_TRIGGERS OFF
GO
ALTER DATABASE [oxigen_live] SET  DISABLE_BROKER
GO
ALTER DATABASE [oxigen_live] SET AUTO_UPDATE_STATISTICS_ASYNC OFF
GO
ALTER DATABASE [oxigen_live] SET DATE_CORRELATION_OPTIMIZATION OFF
GO
ALTER DATABASE [oxigen_live] SET TRUSTWORTHY OFF
GO
ALTER DATABASE [oxigen_live] SET ALLOW_SNAPSHOT_ISOLATION OFF
GO
ALTER DATABASE [oxigen_live] SET PARAMETERIZATION SIMPLE
GO
ALTER DATABASE [oxigen_live] SET READ_COMMITTED_SNAPSHOT OFF
GO
ALTER DATABASE [oxigen_live] SET HONOR_BROKER_PRIORITY OFF
GO
ALTER DATABASE [oxigen_live] SET  READ_WRITE
GO
ALTER DATABASE [oxigen_live] SET RECOVERY FULL
GO
ALTER DATABASE [oxigen_live] SET  MULTI_USER
GO
ALTER DATABASE [oxigen_live] SET PAGE_VERIFY CHECKSUM
GO
ALTER DATABASE [oxigen_live] SET DB_CHAINING OFF
GO
EXEC sys.sp_db_vardecimal_storage_format N'oxigen_live', N'ON'
GO
USE [oxigen_live]
GO

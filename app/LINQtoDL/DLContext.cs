...
{
  /// <summary>
  /// Summary description for DLContext
  /// </summary>
  public class DLContext
  {
    ...
    /// </returns>
    public IEnumerable<T> Read<T>(string fileName, DLFileDescription fileDescription) where T : new()
    {
    ...
    {
      return Read<T>(stream, new DLFileDescription());
    }

    public IEnumerable<T> Read<T>(string fileName) where T : new()
    {
      return Read<T>(fileName, new DLFileDescription());
    }

    public IEnumerable<T> Read<T>(StreamReader stream, DLFileDescription fileDescription) where T : new()
    {
      return ReadData<T>(null, stream, new DLFileDescription());
    }
    ...
    public void Write<T>(
        ...
        TextWriter stream)
    {
      Write<T>(values, stream, new DLFileDescription());
    }
    ...
    public void Write<T>(
        ...
        string fileName)
    {
      Write<T>(values, fileName, new DLFileDescription());
    }
        ...
        DLFileDescription fileDescription)
    {
      ...
      DLStream cs = new DLStream(null, stream, fileDescription.SeparatorChar);

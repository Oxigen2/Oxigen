namespace Setup
{
  partial class UninstallPromptForm
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.label2.Text = "This setup program will remove Oxigen from your computer.";
      // 
      // label4
      // 

...
<% using (Html.BeginForm()) { %>
    ...
    <ul>
		...
		<li>
			...
			<div>
				<%= Html.TextBox("Slide.SlideName", 
					(ViewData.Model.Slide != null) ? ViewData.Model.Slide.SlideName.ToString() : "")%>
			</div>
			<%= Html.ValidationMessage("Slide.SlideName")%>
		</li>
		<li>
			<label for="Slide_Creator">Creator:</label>
			<div>
				<%= Html.TextBox("Slide.Creator", 
					(ViewData.Model.Slide != null) ? ViewData.Model.Slide.Creator.ToString() : "")%>
			</div>
		...
		<li>
			...
			<div>
				<%= Html.TextBox("Slide.Caption", 
					(ViewData.Model.Slide != null) ? ViewData.Model.Slide.Caption.ToString() : "")%>
			</div>
		...
		<li>
			...
			<div>
				<%= Html.TextBox("Slide.WebsiteURL", 
					(ViewData.Model.Slide != null) ? ViewData.Model.Slide.WebsiteURL.ToString() : "")%>
			</div>
		...
		<li>
			...
			<div>
				<%= Html.TextBox("Slide.ImageFilename", 
					(ViewData.Model.Slide != null) ? ViewData.Model.Slide.ImageFilename.ToString() : "")%>
			</div>
			<%= Html.ValidationMessage("Slide.ImageFilename")%>
		</li>
		<li>
			<label for="Slide_PlayerType">PlayerType:</label>
			<div>
				<%= Html.TextBox("Slide.PlayerType", 
					(ViewData.Model.Slide != null) ? ViewData.Model.Slide.PlayerType.ToString() : "")%>
			</div>
		...
		<li>
			...
			<div>
				<%= Html.TextBox("Slide.PreviewType", 
					(ViewData.Model.Slide != null) ? ViewData.Model.Slide.PreviewType.ToString() : "")%>
			</div>

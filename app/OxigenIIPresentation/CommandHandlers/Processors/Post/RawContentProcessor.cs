...
{
  public class RawContentProcessor : PostCommandProcessor
  {
    ...
    internal override string Execute(string[] parameters)
    {
      ...
      if (!int.TryParse(parameters[1], out contentID))
        return ErrorWrapper.SendError("Invalid content ID");
      ...
      try
      {
        ...
        client.PutRawContentProperties(userID, contentID, trimmedTitle, trimmedCreator, trimmedCaption,

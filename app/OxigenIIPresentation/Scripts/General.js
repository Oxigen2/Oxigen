...
function unBlackOut3(clicked) {
  ...
  if (this_div.is('#DivLoginBox') && logged_in != 1 && window.location.href.indexOf('Create.aspx') != -1) { //IF LOGGED OUT AND ON CREATE PAGE AND CLOSING LOGIN WINDOW
...
function chooseClickType(clicked) {
  if (window.location.href.indexOf('Create.aspx') == -1) {
...
function addPreview() {
  ...
  if (curr_url.indexOf('Create.aspx') != -1) {
...
function testProgress() {
  ...
  //alert(v_pos)
  //if (location.href.indexOf('Create.aspx') != -1) {
  //v_pos = v_pos - 70
  //}

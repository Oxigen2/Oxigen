<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="OxigenIIPresentation.Admin.Content.Edit" %>
...
<h1>Edit Raw Content</h1>
   ...
   <div class="AdminLeft">
    ...
    <div class="FormBox">
      <div class="FormLabel"><asp:Label runat="server">Download File:</asp:Label></div>
  ...
  <div class="AdminRight">
    ...
    <div class="FormBox">
      <div class="FormLabel"><asp:Label AssociatedControlID="fuUpload" runat="server">Upload File:&nbsp;<span class="Asterisk">*</span></asp:Label></div>

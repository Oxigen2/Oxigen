...
namespace OxigenIIAdvertising.DataAccess
{
    ...
    public class SqlDatabase : IDisposable
    {
        ...
        public static string strConn
        {
            get
            {
                if (_connectionStringName == null)
                    ...
                    return System.Configuration.ConfigurationManager.ConnectionStrings[_connectionStringName].ConnectionString;
            }
        }
        ...
        public SqlDatabase(string connectionStringName) : this()
        {
